...
- (void)testInitialEmptyViewBackgroundColorIsSameColorAsViewsBackgroundColor
{
    [self.viewController view];
    
    expect(self.viewController.emptyView.backgroundColor).to.equal(self.viewController.view.backgroundColor);
}

- (void)testInitialEmptyViewBackgroundColorIsSameColorAsEmptyViewsBackgroundColor
{
    [self.viewController view];
    
    expect(self.viewController.emptyView.backgroundColor).to.equal(self.viewController.emptyViewBackgroundColor);
}

- (void)testSettingEmptyViewBackgroundColorChangesTheBackgroundColorOnEmptyView
{
    [self.viewController view];
    UIColor *newColor = [UIColor greenColor];
    self.viewController.emptyViewBackgroundColor = newColor;
    expect(self.viewController.emptyView.backgroundColor).to.equal(newColor);
}
@end