...
// TWGExtensions
#define COCOAPODS_POD_AVAILABLE_TWGExtensions
#define COCOAPODS_VERSION_MAJOR_TWGExtensions 0
#define COCOAPODS_VERSION_MINOR_TWGExtensions 1
#define COCOAPODS_VERSION_PATCH_TWGExtensions 3
