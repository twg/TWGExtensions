...
{
    _emptyViewBackgroundColor = emptyViewBackgroundColor;
    self.emptyView.backgroundColor = emptyViewBackgroundColor;
}
...
- (TWGEmptyView *)emptyView
{
    if (!_emptyView) {
        ...
        self.emptyViewBackgroundColor = self.view.backgroundColor;
        self.emptyView.backgroundColor = self.emptyViewBackgroundColor;
    }
    return _emptyView;
}
